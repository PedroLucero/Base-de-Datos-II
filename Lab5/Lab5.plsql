...
create table salario_quincenal(
 ...
 constraint id_codcolaborador foreign key (id_codcolaborador) references
Colaboradores (id_codcolaborador)
);
...
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Pedro', 'Lucero', '8-973-1067', 'M',
TO_DATE('2001-09-01', 'yyyy-mm-dd'), TO_DATE('2024-05-22', 'yyyy-mm-dd'), 'A',
1500);
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Rafaela', 'Black', '8-905-1651', 'F',
TO_DATE('1996-05-23', 'yyyy-mm-dd'), TO_DATE('2024-05-21', 'yyyy-mm-dd'), 'A',
1501);
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Jose', 'Hernandez', '8-1002-2448',
'M', TO_DATE('2003-12-08', 'yyyy-mm-dd'), TO_DATE('2024-05-20', 'yyyy-mm-dd'),
'A', 1502);
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Andres', 'Valdes', '6-726-1938', 'M',
TO_DATE('2004-06-03', 'yyyy-mm-dd'), TO_DATE('2024-05-19', 'yyyy-mm-dd'), 'A',
1503);
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Arantxa', 'Coronado', '2-752-1519',
'F', TO_DATE('2003-10-20', 'yyyy-mm-dd'), TO_DATE('2024-05-18', 'yyyy-mm-dd'),
'A', 1504);
-- 2 Colaboradores de vacaciones
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Juan', 'Perez', '1-111-1111', 'M',
TO_DATE('2000-01-01', 'yyyy-mm-dd'), TO_DATE('2023-12-12', 'yyyy-mm-dd'), 'V',
2501);
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'John', 'Johnson', '2-222-2222', 'M',
TO_DATE('1999-02-02', 'yyyy-mm-dd'), TO_DATE('2023-11-11', 'yyyy-mm-dd'), 'V',
2500);
-- 1 Colaborador retirado
INSERT INTO Colaboradores (id_codcolaborador, nombre, apellido, cedula, sexo,
fecha_nacimiento, fecha_ingreso, estatus, salario_mensual)
 VALUES(colaboradores_sequence.nextval, 'Ramona', 'Gonzalez', '3-333-3333',
'F', TO_DATE('1998-03-03', 'yyyy-mm-dd'), TO_DATE('2023-10-10', 'yyyy-mm-dd'),
'R', 666);
CREATE OR REPLACE VIEW Lab5 AS
    SELECT C.id_codcolaborador AS Codigo,
        ...
        FROM Colaboradores C JOIN salario_quincenal S ON c.id_codcolaborador =
        s.id_codcolaborador;
DECLARE
...
BEGIN
    ...
    v_Fecha := TO_DATE(TO_CHAR(sysdate, 'YYYY') || '-' || TO_CHAR(sysdate,
    'MM') || '-' || 30, 'yyyy-mm-dd');
    END IF;
    ...
    INSERT INTO salario_quincenal(id_salario, id_codcolaborador, fecha_pago,
    salario_quincenal, seguro_social,seguro_educativo, salario_neto)
    VALUES(salarios_sequence.nextval, v_ID, v_Fecha, v_SalarioQ,
    v_SalarioQ*0.0975, v_SalarioQ*0.0125, v_SalarioQ*0.89);
    END LOOP;
EXCEPTION
-- Manejo de excp
WHEN dupval_on_index THEN
    DBMS_OUTPUT.PUT_LINE('Esta llave ya está dentro');
WHEN VALUE_ERROR THEN
 DBMS_OUTPUT.PUT_LINE('Se está insertando un valor errado');
END;