...
BEGIN
    ...
    cargar_transacpagos(1021,2,1,1,TO_DATE('10-05-2023', 'DD-MM-YYYY'),400.00, TO_DATE('10-05-2023 15:30:09', 'DD-MM-YYYY hh24:mi:ss'),1);
    cargar_transacpagos(1022,1,2,2,TO_DATE('10-12-2023', 'DD-MM-YYYY'),150.25, TO_DATE('10-12-2023 3:30:33', 'DD-MM-YYYY hh24:mi:ss'),1);
    cargar_transacpagos(1023,1,2,4,TO_DATE('24-06-2022', 'DD-MM-YYYY'),80.00, TO_DATE('24-06-2022 18:14:54', 'DD-MM-YYYY hh24:mi:ss'),1);
