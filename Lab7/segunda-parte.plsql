...
ALTER TABLE CLIENTE CONSTRAINT CLIENTE_FK_SUCURSAL FOREIGN KEY (COD_SUCURSAL) REFERENCES SUCURSAL(COD_SUCURSAL);
...
ALTER TABLE PRESTAMO_CLIENTE CONSTRAINT PRESTAMO_CLIENTE_FK_SUCURSAL FOREIGN KEY (COD_SUCURSAL) REFERENCES SUCURSAL(COD_SUCURSAL);
...
ALTER TABLE PRESTAMO_CLIENTE CONSTRAINT PRESTAMO_CLIENTE_FK_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES USUARIO(ID_USUARIO);
