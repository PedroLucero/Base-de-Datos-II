...
-- Creación de tabla cliente ***************ERRORRRR**************************
CREATE TABLE CLIENTE (
    ...
    FECHA_NACIMIENTO DATE NOT NULL PROFESION VARCHAR2(50),
    ID_PROFESION NUMBER NOT NULL,
...
-- Creación de tabla email **********ERRRORRR***********
...
-- Creación de tabla telefono **********ERORRRRRR********
CREATE TABLE TELEFONO_CLIENTE (
    ...
    CONSTRAINT FK_TELEFONO_TIPO_TELEFONO FOREIGN KEY (ID_TIPO_TELEFONO) TIPO_TELEFONO(ID_TIPO_TELEFONO)
);

--Creación de la tabla TIPO_PRESTAMO
CREATE TABLE TIPO_PRESTAMO(
    ID_TIPO_PRESTAMO NUMBER NOT NULL,
    DESCRIPCION_PRESAMO VARCHAR2(50) NOT NULL,
    TASA NUMBER(3, 2) NOT NULL
)
 -- Creación de tabla prestamo *******ERROR**********
CREATE TABLE PRESTAMO_CLIENTE(
    ID_TIPO_PRESTAMO NUMBER NOT NULL,
    ID_CLIENTE NUMBER NOT NULL,
    FECHA_APRO DATE NOT NULL,
    NUM_PRESTAMO NUMBER DEFAULT SEQ_PRESTAMO.NEXTVAL NOT NULL,
    ...
    CONSTRAINT FK_PRESTAMO_CLIENTE FOREIGN KEY (ID_TIPO_PRESTAMO) REFERENCES TIPO_PRESTAMO(ID_TIPO_PRESTAMO)
);