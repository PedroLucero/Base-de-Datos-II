...
create table alumno(
    ...
    a_telefono number not null, -- se agrego el atributo telefono

    constraint alumno_fk_telefono references telefono_alumno (telefono),
...
insert into matricula (a_matricula, asignatura, curso_escolar, nota) values(5, 1, 1, 'F');
insert into matricula (a_matricula, asignatura, curso_escolar, nota) values(5, 1, 2, 'C'); --Se agrego otro estudiante repetido
