...
BEGIN
    INSERT INTO MUEBLE(ID, COLOR, LINEA, ANCHO, ALTO, TIPO_MUEBLE,
                        ALTURA, C_PESO, DIVISIONES,
                        ALTURA_SUELO, NUM_DIVISIONES,
                        MATERIAL, T_COMPONENTE,
                        MARMOL, AGLOMERADO, ID_FABRICANTE)
    VALUES(SEQ_MUEBLE.NEXTVAL, p_COLOR, p_LINEA, p_ANCHO, p_ALTO, TIPO,
...
-- Prueba
BEGIN
    INSERTAR_MUEBLE_ALTO('negro', 'Lorem', 30.1, 16.9, 16.9, 259, 7, 1);
    INSERTAR_MUEBLE_BAJO('negro', 'Lorem', 21.0, 29.4, 9, 4, 2);
    INSERTAR_MUEBLE_PANEL('verde', 'Sicilia', 16.4, 30.1, 'vidrio', 13.5, 3);
    INSERTAR_MUEBLE_ENCIMERA('gris', 'Aqua', 30.4, 14.3, 0, 1, 4);
END;
/