...
BEGIN
    IF p_MUEBLES.COUNT != p_CANTIDADES.COUNT THEN
        RAISE_APPLICATION_ERROR(-20001, 'Se insertaron distintas los muebles y sus cantidades no concuerdan');
    END IF;
    INSERT INTO COMPRA(ID_COMPRA, FACTURA_FABRICANTE, ID_FABRICANTE, MONTO)
