...
-------- fin de T's
CREATE TABLE DETALLES_V_MUEBLES(
	NUM_FACTURA NUMBER NOT NULL,
	ID_MUEBLE NUMBER NOT NULL,
	CANTIDAD NUMBER NOT NULL,
...
CREATE TABLE DETALLES_V_COCINAS(
	NUM_FACTURA NUMBER NOT NULL,
	ID_COCINA NUMBER NOT NULL,
	CANTIDAD NUMBER NOT NULL,
...
-- PROCEDIMIENTO DE INSERTAR EN VENTAS: (ID_CLIENTE, COCINAS, CANTIDADES_C, MUEBLES, CANTIDADES_M, ID_REPARTIDOR, MONTADOR, FECHA_VENTA, FECHA_ENTREGA)
