...
BEGIN
    ...
    INSERT INTO VENTA(NUM_FACTURA, SUBTOTAL, IMPUESTO, TOTAL, ID_CLIENTE, FECHA_VENTA)
    VALUES(SEQ_VENTA.NEXTVAL, 0, 0, 0, p_ID_CLIENTE, SYSDATE);
...
BEGIN
    ...
    REGISTRAR_VENTA(V_ID_CLIENTE, V_COCINAS, V_C_COCINAS, V_MUEBLES, V_C_MUEBLES,
